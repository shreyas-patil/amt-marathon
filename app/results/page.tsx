  ...
  return (
    <div className="pt-16 bg-white min-h-screen flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-zinc-900 text-4xl font-black mb-4">Not yet.</h1>
        ...
        <p className="text-zinc-400 leading-relaxed">
          Results, rankings, and prize winners will be published here once the last runner crosses
          the finish line. Come back then.
        </p>
      </div>
    </div>
  )

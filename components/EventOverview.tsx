        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            >
              ...
              <span>
                <span className="block text-xs font-semibold tracking-[0.2em] uppercase text-zinc-500 mb-1">Start Line</span>
            ...
            <div className="flex items-start gap-4 mb-8 p-4 rounded-xl border border-amber-500/20 bg-amber-500/5">
              ...
              <span>
                <span className="block text-xs font-semibold tracking-[0.2em] uppercase text-amber-500/70 mb-1">Bib Collection</span>
